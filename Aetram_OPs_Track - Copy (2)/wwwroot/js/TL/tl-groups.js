...
import { getWithAuth, postWithAuth, deleteWithAuth } from '/js/services/apiService.js';
...
$(function () {
    ...
    const API = {
        ...
        deleteSubGroup: '/api/tl/subgroups/delete',
    ...
    async function loadSubGroups() {
        ...
        try {
            ...
            subGroups = response.data || response;
        } catch (err) {
            subGroups = DEMO.subGroups;
        }
        renderSubGroups();
    }
