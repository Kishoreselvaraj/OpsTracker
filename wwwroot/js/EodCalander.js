...
import { getMonthlyCalendar, saveWorkLog } from '/js/services/workLogService.js';
import { submitEod as submitEodApi } from '/js/services/eodService.js';
import { loadTaskGroups, loadSubGroups, setHierarchyCacheFromCalendar, getCachedGroups, getCachedSubGroups } from '/js/services/hierarchyService.js';
    ...
    async function submitEod() {
        ...
        if (isFormVisible) {
            ...
            try {
                ...
                const wfId = saveResult.data?.workflowLogDateId ?? saveResult.raw?.workflowLogDateId ?? data.workflowLogDateId;
        ...
        const eodId = editingWorkflowLogDateId
            || (refreshedLogs[0]?.workflowLogDateId)
            || 0;
